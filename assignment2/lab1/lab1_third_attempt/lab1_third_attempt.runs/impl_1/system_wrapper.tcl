...
set rc [catch {
  ...
  set_property webtalk.parent_dir F:/AU/ERTS/vivado_workspace/lab1_third_attempt/lab1_third_attempt.cache/wt [current_project]
  set_property parent.project_path F:/AU/ERTS/vivado_workspace/lab1_third_attempt/lab1_third_attempt.xpr [current_project]
  set_property ip_output_repo F:/AU/ERTS/vivado_workspace/lab1_third_attempt/lab1_third_attempt.cache/ip [current_project]
  set_property ip_cache_permissions {read write} [current_project]
  set_property XPM_LIBRARIES XPM_CDC [current_project]
  add_files -quiet F:/AU/ERTS/vivado_workspace/lab1_third_attempt/lab1_third_attempt.runs/synth_1/system_wrapper.dcp
  set_msg_config -source 4 -id {BD 41-1661} -suppress
  set_param project.isImplRun true
  add_files F:/AU/ERTS/vivado_workspace/lab1_third_attempt/lab1_third_attempt.srcs/sources_1/bd/system/system.bd
  set_property is_locked true [get_files F:/AU/ERTS/vivado_workspace/lab1_third_attempt/lab1_third_attempt.srcs/sources_1/bd/system/system.bd]
  set_param project.isImplRun false
  read_xdc F:/AU/ERTS/vivado_workspace/lab1_third_attempt/lab1_third_attempt.srcs/constrs_1/imports/lab1/lab1_zybo.xdc
  set_param project.isImplRun true
